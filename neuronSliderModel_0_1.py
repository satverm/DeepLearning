#this is the basic star poinr for a neuron model
# it will be modified to scale up in terms of inputs and xonverting the neuron as a class object itself so that scaling can be implimented
...
class NeuronGUI(tk.Tk):
    def __init__(self, inputs, neurons):
        ...
        weight_slider = tk.Scale(self, from_=-1, to=1, resolution=0.01, orient="horizontal", variable=self.weight,
        ...
        bias_slider = tk.Scale(self, from_=-1, to=1, resolution=0.1, orient="vertical", variable=self.bias,
                               command=self.update_output)
        bias_slider.set(0)
        ...
        input_slider = tk.Scale(self, from_=-1, to=1, resolution=0.1, orient="horizontal", variable=self.input_val,
                                command=self.update_output)
        input_slider.set(0)
